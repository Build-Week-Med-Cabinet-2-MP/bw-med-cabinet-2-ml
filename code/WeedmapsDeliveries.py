...
URL = "https://api-g.weedmaps.com/discovery/v1/listings?sort_by=position_distance&filter%5Bany_retailer_services%5D%5B%5D=delivery&page_size=25&page={}"
HEADERS = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36'}


class WeedmapsDeliveries():
  """Save Weedmaps.com cannabis delivery database to file
  ...
  def scrape_to_csv(self, output_file):
    """Scrape Weedmaps Delivert API and save to file
    
    Args:
        output_file: path to save csv file with delivery data
    ...
    self.storefronts_df.to_csv(self.output_file, index=False)
